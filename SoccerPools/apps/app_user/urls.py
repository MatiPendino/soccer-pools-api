...
urlpatterns = [
    ...
    path('google_oauth2/', GoogleLoginView.as_view(), name='google-oauth2'),
    path('android_google_oauth2/', GoogleLoginView.as_view(), name='android-google-oauth2'),  # Deprecated, kept for backwards compatibility
