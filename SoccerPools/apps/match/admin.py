...
class MatchResultAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    def get_user_username(self, obj):
        return obj.bet_round.bet_league.get_user_username() if (obj.bet_round and obj.bet_round.bet_league) else 'admin'
    get_user_username.admin_order_field = 'bet_round__bet_league__user__username'
