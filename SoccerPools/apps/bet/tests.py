...
class BetRoundResultsTest(APITestCase):
    def setUp(self):
        ...
        self.team_5 = TeamFactory(league=self.league, leagues=[self.league])
        self.team_6 = TeamFactory(league=self.league, leagues=[self.league])
...
class LeagueBetsMatchResultsCreateTest(APITestCase):
    ...
    def test_already_created_bet_league(self):
        ...
        """
        self.team_7 = TeamFactory(league=self.league, leagues=[self.league])
        self.team_8 = TeamFactory(league=self.league, leagues=[self.league])
        self.team_9 = TeamFactory(league=self.league, leagues=[self.league])
        self.team_10 = TeamFactory(league=self.league, leagues=[self.league])
