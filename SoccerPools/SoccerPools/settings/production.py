...
# MercadoPago - override base defaults to require in production
...
PAYMENT_FAILURE_URL = config('PAYMENT_FAILURE_URL')
PAYMENT_PENDING_URL = config('PAYMENT_PENDING_URL')
